-- Restaura el intervalo fijo de la organización (p. ej. 15 min) para recorrer slots.
-- La duración total de los servicios solo define cuánto espacio necesita cada turno,
-- no el paso entre candidatos. Usar la duración como intervalo omitía horarios válidos
-- justo después de un turno ocupado (p. ej. 11:00 tras un turno de 10:30–11:00).
