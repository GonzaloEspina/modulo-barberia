...
export function PortalPoints({
  ...
  return (
    <Card className="gap-0 rounded-sm py-3 shadow-none">
      <CardContent className="space-y-2 px-4">
        <div className="flex items-baseline justify-between gap-3">
          <div className="min-w-0">
            <p className="font-display text-base font-semibold tracking-wide uppercase">Tus puntos</p>
            {nextExpiresAt && (
          ...
          <p className="font-display text-3xl font-semibold tracking-wide tabular-nums">{balance}</p>
        </div>
